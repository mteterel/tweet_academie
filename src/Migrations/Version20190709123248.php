 ...
 */
final class Version20190709123248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE username username VARCHAR(16) NOT NULL, CHANGE display_name display_name VARCHAR(24) NOT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE birth_date birth_date DATE DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE gender gender SMALLINT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE username username VARCHAR(32) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE display_name display_name VARCHAR(64) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE email email VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE birth_date birth_date DATE DEFAULT \'NULL\', CHANGE city city VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE gender gender SMALLINT DEFAULT NULL');
    }
}
