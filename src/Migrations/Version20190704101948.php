 ...
 */
final class Version20190704101948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE upload (id INT AUTO_INCREMENT NOT NULL, uploader_id INT DEFAULT NULL, path VARCHAR(255) NOT NULL, INDEX IDX_17BDE61F16678C77 (uploader_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
