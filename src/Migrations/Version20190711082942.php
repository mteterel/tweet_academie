 ...
 */
final class Version20190711082942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post_hashtag (hashtag_id INT NOT NULL, post_id INT NOT NULL, INDEX IDX_675D9D52FB34EF56 (hashtag_id), INDEX IDX_675D9D524B89032C (post_id), PRIMARY KEY(hashtag_id, post_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE hashtag_post (hashtag_id INT NOT NULL, post_id INT NOT NULL, INDEX IDX_EFB384144B89032C (post_id), INDEX IDX_EFB38414FB34EF56 (hashtag_id), PRIMARY KEY(hashtag_id, post_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
