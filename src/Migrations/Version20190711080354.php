 ...
 */
final class Version20190711080354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8D256BB44 FOREIGN KEY (source_post_id) REFERENCES post (id) ON DELETE CASCADE');
