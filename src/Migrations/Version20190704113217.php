 ...
 */
final class Version20190704113217 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE upload ADD type VARCHAR(255) DEFAULT NULL, CHANGE uploader_id uploader_id INT DEFAULT NULL');
